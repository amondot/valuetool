...
class Ui_ValueWidgetBase(object):
    def setupUi(self, ValueWidgetBase):
        ...
        ValueWidgetBase.resize(564, 404)
        ...
        self.horizontalLayout.addWidget(self.spinDigits)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.verticalLayout_5.addLayout(self.horizontalLayout)
        self.horizontalLayout_4 = QtGui.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.cbxVoisinage = QtGui.QCheckBox(self.widget)
    ...
    def retranslateUi(self, ValueWidgetBase):
        ...
        self.cbxVoisinage.setText(_translate("ValueWidgetBase", "Neighborhood", None))
        ...
        item.setText(_translate("ValueWidgetBase", "Pixel", None))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("ValueWidgetBase", "Line", None))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("ValueWidgetBase", "Average", None))
